...
- Five-of-six follow-up issues closed `completed`, one closed `not_planned` (lucos_repos#404 — its proposed mechanism doesn't exist in the convention engine). All three associated PRs in `lucos_claude_config` (#99/100/101) merged. ADR-0008 (lucas42/lucos#199) merged.

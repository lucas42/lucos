...
| Add a `publish-docker` end-to-end test on the orb's own CI that exercises the mirror probe and `imagetools create` paths against a real registry response | **Not yet raised** | To do |

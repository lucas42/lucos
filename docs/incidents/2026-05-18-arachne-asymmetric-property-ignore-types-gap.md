...
| Time (UTC) | Event |
|---|---|
| 2026-05-17 21:53 | `lucas42/lucos_eolas#256` merged — declares `eolas:preferredIdentifier` predicate with `rdf:type owl:AsymmetricProperty, owl:ObjectProperty` and a `skos:prefLabel`. |
...
| 2026-05-18 ~12:00 | lucas42 raises the alert with SRE, providing the link to `lucas42/lucos_eolas#256`. |
...
| 2026-05-18 12:21:35 | `lucas42/lucos_arachne#543` merged. |
